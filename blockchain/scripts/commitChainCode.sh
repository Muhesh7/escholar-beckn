...
commitChaincodeDefinition() {
  ...
  --peerAddresses localhost:7051 --tlsRootCertFiles ${PWD}/organizations/peerOrganizations/provider.escholar.captainirs.dev/peers/peer0.provider.escholar.captainirs.dev/tls/ca.crt \
    --peerAddresses localhost:9051 --tlsRootCertFiles ${PWD}/organizations/peerOrganizations/benefactors.escholar.captainirs.dev/peers/peer0.benefactors.escholar.captainirs.dev/tls/ca.crt \
