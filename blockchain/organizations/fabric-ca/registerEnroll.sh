...
function createOrg() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:${PORT} --caname ca-${SUBDOMAIN} --tls.certfiles ${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  # Copy organization's CA cert to organization's /msp/tlscacerts directory (for use in the channel MSP definition)
  mkdir -p "${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/msp/tlscacerts"
  cp "${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem" "${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/msp/tlscacerts/ca.crt"

  # Copy organization's CA cert to organization's /tlsca directory (for use by clients)
  mkdir -p "${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/tlsca"
  cp "${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem" "${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/tlsca/tlsca.${SUBDOMAIN}.${DOMAIN}-cert.pem"

  # Copy organization's CA cert to organization's /ca directory (for use by clients)
  mkdir -p "${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/ca"
  cp "${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem" "${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/ca/ca.${SUBDOMAIN}.${DOMAIN}-cert.pem"

  infoln "Registering peer0"
  set -x
  fabric-ca-client register --caname ca-${SUBDOMAIN} --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-${SUBDOMAIN} --id.name user1 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-${SUBDOMAIN} --id.name ${SUBDOMAIN}admin --id.secret ${SUBDOMAIN}adminpw --id.type admin --tls.certfiles ${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:${PORT} --caname ca-${SUBDOMAIN} -M ${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/peers/peer0.${SUBDOMAIN}.${DOMAIN}/msp --csr.hosts peer0.${SUBDOMAIN}.${DOMAIN} --tls.certfiles ${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:${PORT} --caname ca-${SUBDOMAIN} -M ${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/users/User1@${SUBDOMAIN}.${DOMAIN}/msp --tls.certfiles ${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://${SUBDOMAIN}admin:${SUBDOMAIN}adminpw@localhost:${PORT} --caname ca-${SUBDOMAIN} -M ${PWD}/organizations/peerOrganizations/${SUBDOMAIN}.${DOMAIN}/users/Admin@${SUBDOMAIN}.${DOMAIN}/msp --tls.certfiles ${PWD}/organizations/fabric-ca/${SUBDOMAIN}/ca-cert.pem
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  mkdir -p "${PWD}/organizations/ordererOrganizations/escholar.captainirs.dev/msp/tlscacerts"
  cp "${PWD}/organizations/fabric-ca/orderer/ca-cert.pem" "${PWD}/organizations/ordererOrganizations/escholar.captainirs.dev/msp/tlscacerts/tlsca.escholar.captainirs.dev-cert.pem"

  # Copy orderer org's CA cert to orderer org's /tlsca directory (for use by clients)
  mkdir -p "${PWD}/organizations/ordererOrganizations/escholar.captainirs.dev/tlsca"
  cp "${PWD}/organizations/fabric-ca/orderer/ca-cert.pem" "${PWD}/organizations/ordererOrganizations/escholar.captainirs.dev/tlsca/tlsca.escholar.captainirs.dev-cert.pem"
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/${DOMAIN}/orderers/orderer.${DOMAIN}/msp --csr.hosts orderer.${DOMAIN} --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/orderer/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/${DOMAIN}/orderers/orderer.${DOMAIN}/tls --enrollment.profile tls --csr.hosts orderer.${DOMAIN} --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/orderer/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/${DOMAIN}/users/Admin@${DOMAIN}/msp --tls.certfiles ${PWD}/organizations/fabric-ca/orderer/ca-cert.pem
  { set +x; } 2>/dev/null
