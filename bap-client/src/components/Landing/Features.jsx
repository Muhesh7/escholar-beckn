...
export const FEATURES = [
  {
    ...
    description:
        'E-Scholar is a web application that allows you to generate digitally signed scholarships.'
  },
  {
    icon: IconUser,
  ...
  },
  {
    ...
    description:
        'All data is encrypted and stored in a secure blockchain. Only the applicant can access their data.'
  },
  {
    icon: IconCertificate,
    title: 'Digital Certificates',
    description:
        'E-Scholar is the first scholarship that is digitally signed by a trusted authority.'
  },
  {
    icon: IconPlant,
